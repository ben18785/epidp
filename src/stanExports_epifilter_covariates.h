...
static constexpr std::array<const char*, 51> locations_array__ =
  ...
  " (in 'epifilter_covariates', line 12, column 2 to column 29)",
  " (in 'epifilter_covariates', line 15, column 2 to column 20)",
  " (in 'epifilter_covariates', line 16, column 2 to column 23)",
  ...
  " (in 'epifilter_covariates', line 3, column 2 to column 17)",
  ...
  " (in 'epifilter_covariates', line 12, column 18 to column 19)",
  " (in 'epifilter_covariates', line 15, column 9 to column 10)",
...
public:
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_covariates) + "},\"block\":\"parameters\"},{\"name\":\"epsilon\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"E_cases\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"R\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_likelihood\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
