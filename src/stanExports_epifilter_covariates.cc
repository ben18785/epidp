...
#include "stanExports_epifilter_covariates.h"

RCPP_MODULE(stan_fit4epifilter_covariates_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_epifilter_covariates")
