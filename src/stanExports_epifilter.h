...
static constexpr std::array<const char*, 41> locations_array__ =
  ...
  " (in 'epifilter', line 8, column 2 to column 21)",
  " (in 'epifilter', line 9, column 2 to column 22)",
  " (in 'epifilter', line 12, column 2 to column 18)",
  ...
  " (in 'epifilter', line 3, column 2 to column 11)",
  ...
  " (in 'epifilter', line 12, column 15 to column 16)",
...
public:
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      R = in__.template read_constrain_lb<std::vector<local_scalar_t__>,
            jacobian__>(0, lp__, N);
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      std::vector<local_scalar_t__> R =
        std::vector<local_scalar_t__>(N, DUMMY_VAR__);
      current_statement__ = 1;
      stan::model::assign(R, in__.read<std::vector<local_scalar_t__>>(N),
